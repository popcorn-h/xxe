    ...
    <div class="addbg">
      <div class="container recommend">
        ...
        <div class="recommend-rec">
          <div class="radio"><i></i><span>赛事推荐</span></div>
          <div class="right-rec">
            <div>进行中...</div>
            <div>
              <i class="fa fa-heart-o pointer"></i><i class="pointer"></i>
            </div>
          </div>
        </div>
          ...
          <ul>
            <li>
              <div>
                ...
                <span> 12-27 17:00</span>
              </div>
              <div>
                <div>OSOLS<img src="../images/OMG.jpeg" alt="" /></div>
                <span>vs</span>
                <div>OSOLS<img src="../images/OMG.jpeg" alt="" /></div>
              </div>
              <div>
        ...
        <div class="dataShow">
          <div class="chart">
            ...
            <div class="chart-left">
              <div class="chart-nav">
                <div id=""><span></span>TYLOO</div>
                <div id="" class="cor-remdata">
                  75%
                </div>
              </div>
              <div class="relative show">
                <div class="absolute"></div>
                <div class="minshow relative">
                  <div class="absolute dw"></div>
                  <div class="hard">
                    <span></span>
                    数据展示
                    <span></span>
                  ...
                  >
                    ...
                    <div id="line" style="width: 80%;"></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="relative show">
                ...
                <div class="minshow relative">
                  ...
                  >
                    ...
                    <div id="line2" style="width: 80%;"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="add-table">
            <ul>
              <li>
                <div>
                  <img src="../images/OMG.jpeg" alt="" />
                  <span>11-27 20:30</span>
                </div>
                <div class="main-center">
                  <div><p>sjosljsljr第一季公开赛</p></div>
                  <div>
                    <span>OMG</span><img src="../images/OMG.jpeg" alt="" />vs
                    <span>OMG</span><img src="../images/OMG.jpeg" alt="" />
                  </div>
                </div>
                <div>
...
export default {
  ...
  methods: {
    initecharts() {
      ...
      //雷达图
      var container12 =this.$echarts.init(document.getElementById("container12"));
      container12.setOption(option);

      var line2 = this.$echarts.init(document.getElementById("line2"));
        ...
        series: [
          {
            ...
            data: [
              {
                value: 1,
                symbol: "image://images/banner_07.png",
                symbolSize: 20
              },
              {
                value: 0,
